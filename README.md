...
Since this tool acts as an orchestrator, **you must have the underlying security tools installed on your host operating system** (Kali Linux, Ubuntu, or WSL2 recommended).

### 1. System Requirements
* **Python** 3.8+
* **Node.js** v16+ & **npm**

### 2. OS-Level Security Tools
Ensure the following tools are installed and accessible via your system's `PATH`:
* `nmap`
* `whatweb`
* `sublist3r`
* `gobuster`
