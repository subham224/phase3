...
#     sublist3r_info: Optional[List[Dict[str, Any]]] = []  # <--- CHANGED
#     gobuster_info: Optional[List[Dict[str, Any]]] = []
#     nmap_info: Dict
#     wapiti_info: Dict
#     skipfish_info: Dict
...
class ScanResponse(BaseModel):
    whatweb_info: Optional[List[Dict[str, Any]]] = []
    sublist3r_info: Optional[List[Dict[str, Any]]] = [] 
    gobuster_info: Optional[List[Dict[str, Any]]] = []
    nmap_info: Optional[Dict[str, Any]] = {}
    wapiti_info: Optional[Dict[str, Any]] = {}
    skipfish_info: Optional[Dict[str, Any]] = {}
    sqlmap_info: Optional[Dict[str, Any]] = {}
    metasploit_info: Optional[Dict[str, Any]] = {}
    ai_output_files: Optional[Dict[str, List[str]]] = {}
