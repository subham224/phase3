  ...
  if (!data || !data.vulnerabilities || data.vulnerabilities.length === 0) {
    return (
      <div className="bg-gray-800 rounded-lg p-4 shadow-md mb-4 border border-gray-700">
        ...
        {/* <h3 className="text-xl font-semibold text-sky-400">SQLMap Database Scan</h3> */}
        {/* <h3 style={{ color: '#1f2ce9', fontSize: '1.25rem', fontWeight: '600', marginBottom: '15px' }}>
  SQLMap Database Scan
</h3> */}
        <p className="text-gray-400 mt-2">No SQL injection vulnerabilities detected.</p>
      </div>
    );
  }
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-gray-900 text-gray-300">
              <th className="p-3 border-b border-gray-700">Method</th>
              <th className="p-3 border-b border-gray-700">Parameter</th>
